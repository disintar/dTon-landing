...
export const BookCall = ({style={}, size = 'small'}) => {
    ...
    return <button style={{...sizes[size], ...style }} onClick={()=> window.open('https://calendly.com/tvorogme/30min-1', '_blank')} className='btn-primary' >
       Book Call
    </button>
}
...
export const StartUsing = ({style, href}) => {
    return <button onClick={()=> window.open(href,'_blank')} style={style} className='btn-blue'>Start using</button>
}
